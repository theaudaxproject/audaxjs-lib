...
describe('audaxjs-lib (BIP32)', function () {
  it('can import a BIP32 testnet xpriv and export to WIF', function () {
    ...
    var node = audaxjs.HDNode.fromBase58(xpriv, audaxjs.networks.testnet)
  ...
  it('can export a BIP32 xpriv, then import it', function () {
    ...
    var node = audaxjs.HDNode.fromSeedBuffer(seed)
    var string = node.toBase58()
    var restored = audaxjs.HDNode.fromBase58(string)
  ...
  it('can create a BIP32, audaxjs, account 0, external address', function () {
    var path = "m/0'/0/0"
    var root = audaxjs.HDNode.fromSeedHex('dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd')
  ...
  it('can create a BIP44, audaxjs, account 0, external address', function () {
    var root = audaxjs.HDNode.fromSeedHex('dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd')
  ...
  it('can create a BIP49, audaxjs testnet, account 0, external address', function () {
    var mnemonic = 'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about'
    var seed = bip39.mnemonicToSeed(mnemonic)
    var root = audaxjs.HDNode.fromSeedBuffer(seed)

    var path = "m/49'/1'/0'/0/0"
    var child = root.derivePath(path)

    var keyhash = audaxjs.crypto.hash160(child.getPublicKeyBuffer())
    var scriptSig = audaxjs.script.witnessPubKeyHash.output.encode(keyhash)
    var addressBytes = audaxjs.crypto.hash160(scriptSig)
    var outputScript = audaxjs.script.scriptHash.output.encode(addressBytes)
    var address = audaxjs.address.fromOutputScript(outputScript, audaxjs.networks.testnet)
